...
<section class="card span4"><div class="label">System 1 State</div><div id="systemState" class="hero-state">LISTENING</div><div class="status-line"><span id="commitBadge" class="badge">NOT COMMITTED</span><span id="endpointBadge" class="badge">ENDPOINT IDLE</span><span id="recoveryBadge" class="badge" hidden>STT TURN INVALIDATED</span></div><div id="recoveryDetail" class="muted" hidden></div></section>
